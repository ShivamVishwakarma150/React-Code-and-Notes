...
export default function TwoWayBinding() {
    const [product,setProduct]=useState({Name:'',City:'',Stock:false});
      ...
      <div className="row">
        <div className="col-3">
          ...
          <dl>
            <dt>Name</dt>
            <dd>
              <input className="form-control" onChange={handleName} type="text" />
            </dd>
            <dt>Price</dt>
            <dd>
              <input className="form-control" onChange={handlePrice} type="text" />
            </dd>
            <dt>City</dt>
            <dd>
